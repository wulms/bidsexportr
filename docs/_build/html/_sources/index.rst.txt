...
.. toctree::
   ...
   functions/check_bids_path.md
   functions/copy_files.md
   functions/create_bids_df.md
   functions/create_bids_metadata.md
   functions/create_mock_data.md
   functions/create_participants_tsv.md
   functions/create_presets.md
   functions/filter_dialog.md
   functions/filter_file_dialog.md
   functions/list_BIDS_files.md
   functions/path_to_folder.md
   functions/pipe.md
   functions/start_export.md
   functions/test_filter.md
